	...
	<section class="bloc3">
		<h4>Liste des informations de sécutité publiés</h4>

		<article>
			<div class="row detail">
				<p>Défibrilateurs<br></p>
			</div>

			<div class="row text">
				<ul>Des défibrilateurs sont disponibles aux points suivant :
					<li>12 Place des défibrilateurs</li>
					<li>75002</li>
				</ul>
			</div>
	...
	<article>
			...
			<div class="row detail">
				<p>Lieu :Musée BdC<br>Horaires : Du lundi au vendredi de 11h00 à 23h00</p>
			</div>
