	<section class="bloc2">
		<h4>Créer une rubrique</h4>

		<article>
			<form action="">
				<div class="row">
					<p class="stay-strong">Intitulé de la rubrique</p>
		...
		<article>
			<h4>Créer un nouveau bloc démarche</h4>
			<form action="">
					<div class="row options">
					<p class="stay-strong">Rubrique à associer au bloc</p>
					<div><p>Particuliert</p><svg class="icon" height="18" width="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.41 7.84L12 12.42l4.59-4.58L18 9.25l-6 6-6-6z"/><path d="M0-.75h24v24H0z" fill="none"/></svg></div>
				</div>
	...
	<section class="bloc4">
		...
		<article>
			<div class="row ">
				<p>Mariage<br>
				Latius iam disseminata licentia onerosus bonis omnibus Caesar nullum post haec adhibens modum orientis latera cuncta vexabat nec honoratis parcens nec urbium primatibus nec plebeiis.</p>
			</div>
			<div class="editing">
				<a href="" class="button edit"> 
					<svg class="icon" height="18" width="18" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
