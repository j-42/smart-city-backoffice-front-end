	<section class="bloc2">
		<h4>Créer un nouveau statut</h4>

		<article>
			<form action="">
				<div class="row">
					<p class="stay-strong">Intitulé du statut</p>
		...
		<article>
			...
			<form action="">
					...
					<p class="stay-strong">Statut à associer à la fiche</p>
					<div><p>Maire adjoint</p><svg class="icon" height="18" width="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M7.41 7.84L12 12.42l4.59-4.58L18 9.25l-6 6-6-6z"/><path d="M0-.75h24v24H0z" fill="none"/></svg></div>
				</div>
	...
	<section class="bloc4">
		...
		<article>
			<div class="row person">
				<img src="images/charles-henri.jpg" alt="elu">
				<div>
					<p class="name">Charle-Henri des Olivettes</p>
					<p class="desc">Vide, quantum, inquam, fallare, Torquate. oratio me istius philosophi non offendit; nam et complectitur verbis, quod vult</p>
					<p class="function">Chargé de mission</p>
				</div>
			</div>
			<div class="editing">
				<a href="" class="button edit"> 
			...
			<div class="row person">
				<img src="images/georgette.jpg" alt="elu">
				<div>
					<p class="name">Georgette Poutoupoutou</p>
					<p class="desc">Poratio me istius philosophi non offendit; nam et complectitur verbis. Vide, quantum, inquam, fallare, Torquate. oratio me istius philosophi non offendit;  Vide, quantum, inquam, fallare, Torquate. oratio me istius philosophi non offendi nam et complectitur verbis, quod vult</p>
					<p class="function">Maire</p>
				</div>
			</div>
			<div class="editing">
				<a href="" class="button edit"> 
