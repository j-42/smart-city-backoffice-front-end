	<section class="bloc2">
		<h4>Modifier les informations pratiques</h4>
		...
		<article>
			<form action="">
				...
				<div class="row">
					<p>Surtitre</p>
					<input name="titre" type="text" placeholder="Informations pratiques">
				</div>

				<div class="row">
					<p>Titre</p>
					<input name="titre" type="text" placeholder="Infos Mairie">
				</div>

				<div class="row illustration">
					<p class="stay-strong">Choisir une image d'en-tête</p>
				...
				<div class="row submit">
					<button class="sve">Enregistrer</button>
				</div>
	...
	<section class="bloc3">
		...
		<article>
			<div class="row titre">
				<p>Information pratique<br />Démarches administratives</p>
			</div>

			<div class="row">
				<img src="images/demarches.jpg" alt="">
			</div>
		...
		<article>
			<div class="row titre">
				<p>Information pratique<br />Info Mairie</p>
			</div>
